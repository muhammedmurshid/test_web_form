...
class ZohoIntegration(http.Controller):
    ...
    def lead_form(self, **kwargs):
        ...
        return request.render('test_web_form.lead_web_enquire_form')
    ...
    def lead_form_submit(self, **kwargs):
        ...
        return request.render('test_web_form.tmp_lead_enquire_form_success')

    @http.route(['/lead_web_form'], type='http', auth='public', website=True, csrf=False)
    def lead_web_form(self, **kwargs):
        return request.render('test_web_form.lead_web_enquire_second_form')
